...
### 05-17 [ 黑群晖命令行手动扩容  ](talking/expand_black-synology_capacity_with_manual_command.md)

2020年10月，在公众号博主的种草下，花了 400大洋，入手了蜗牛星际A 款 NAS（四盘位） ，即大伙儿口中的 **“黑群晖”**。


当时存储需求不大，约为 5.23TB 可用空间。

随着备份数据的增长，磁盘容量日趋紧张，直至飘红。


于是不得不买了块新盘，计划花几分钟安装到硬盘托架，扩上去。
...
### 05-15 [金句摘录 | 《复杂世界的明白人》](talking/SmartPeople_in_the_ComplexWorld.md)
...
最近花了点时间，摘录其中的一些金句，偷个懒，就当是读书笔记吧库🤣
...
### 05-02 [原来，那些健身方法全是错的！](talking/what_we_know_about_exercise_is_wrong.md)
